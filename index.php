        ...
        <div class="grid-cols-2">
          <div class="grid-item-1">
            <h1 class="main-heading">
              Welcome to <span>QUEST GEN</span>
              <br />
              Develop Question Papers.
            </h1>
            <p class="info-text">
              Build a beautiful, Question Paper with flexible components built
              from scratch.
            </p>

            <div class="btn_wrapper">
              <button class="btn view_more_btn" onClick="handleClick()">
                Get Started<i class="ri-arrow-right-line"></i>
              </button>

              <button class="btn documentation_btn">How its work</button>
            </div>
          </div>
          <div class="grid-item-2">
            <div class="team_img_wrapper">
              <img src="https://www.edusys.co/images/question-paper-generator.png" alt="team-img" />
            </div>
          </div>
        </div>
      </div>
